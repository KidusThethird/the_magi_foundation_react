...
<div className='mx-10 md:mx-24 p-8 mt-16 pt-4 bg-sky-700 text-gray-300 rounded-xl shadow-lg shadow-black space-y-3'>
   ...
   <p><span className='font-bold'> Loyalty -</span> We are committed to being consistent and devoted to improving the lives of The Magi children.</p>
   <p><span className='font-bold'> Inspiration -</span> It is our commitment to inspire and support orphans and vulnerable children towards lives of hope, reaching their full potential as productive members of their Ethiopian society, contributing to the development of a stronger nation.</p>
   <p><span className='font-bold'> Trustworthiness -</span>To ensure that we manage funds entrusted to us and channel them solely for intended purpose- the well being of the children. Furthermore, we aim to ensure that all supporters, volunteers and Friends of The Magi Foundation honor international child protection standards.</p>
   <p><span className='font-bold'> Training -</span> To provide education and support specifically designed to assist guardians to be able to adequately nurture orphaned and vulnerable children within their community</p>
</div>
    </div>
  )
}
