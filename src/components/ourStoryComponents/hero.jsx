    ...
    <div className='bg-gray-300 relative'>
        <div className='grid grid-cols-2 '>
            ...
            <div className='py-10 pr-10 flex h-full z-10'>
                <div className='p-10 my-auto bg-blue-700 shadow-2xl shadow-black '>
                   <div className='text-4xl font-semibold flex space-x-2'>
                     ...
                     <div className='pt-5 '>
                     <button className='bg-sky-700 text-white px-3 py-1 rounded' >Learn More</button>
                     </div>
                </div>
            </div>
        </div>

        <div className='absolute h-1/2 w-1/2 left-1/3 bg-sky-700 bottom-8 z-0'>

        </div>
        <div className='absolute h-64 w-64 shadow-2xl shadow-orange-500 right-0 rounded-full bg-sky-700 top-24 z-0'>
