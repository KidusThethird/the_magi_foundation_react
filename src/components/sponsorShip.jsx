...
{KidsList.map((kid)=>{
    ...
    <div className='flex w-full   py-10' >
        <button className='text-white font-semibold bg-sky-700 mx-auto py-3 
        px-5 rounded-full hover:bg-white hover:text-sky-700 hover:border-2 border-sky-700 duration-300'>Load More SponsorShips</button>
    </div>
