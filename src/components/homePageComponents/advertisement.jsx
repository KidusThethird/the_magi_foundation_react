  ...
  return (
    <div>
        {AdvertisementList.map((ad)=>{
           return <div className='slg:grid grid-cols-3 shadow-xl shadow-sky-300 mx-5 md:mx-20  rounded-2xl bg-gradient-to-b slg:bg-gradient-to-r from-sky-700 to-gray-300'>
