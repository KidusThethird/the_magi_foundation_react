...
const About = () => {
  return (
    <div className='grid grid-cols-2 p-14 text-gray-700'>

<div>
  <div className='flex text-5xl font-semibold space-x-2'>
    <h1 className=''>Our</h1> <h1 className='text-sky-500 underline'>Story</h1>
    </div>

    <h1 className='text-4xl font-semibold py-6'>About the Organization</h1>
   ...
   <div className='flex space-x-4 pt-5'>
    <button className='border-2 border-sky-700 text-sky-700 rounded-full px-3 py-1'>Read More</button>
    <button className='text-white bg-sky-700 rounded-full px-3 py-2 '>Check out Events</button>
    </div> 
</div>


<div className='my-auto p-14'>
