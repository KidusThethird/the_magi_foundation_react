      ...
      <div className="py-20">
        <div className="w-full flex">
          <div className="flex mx-auto pb-9 text-4xl font-semibold">
            <h1 className="text-gray-700">Bl</h1>
            <h1 className="text-sky-700 underline">ogs</h1>
          </div>
        </div>
        ...
        <div className="grid grid:grid-cols-1 lsm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-5 mx-5">
          {BlogList.map((blog) => {
            return (
              <div
                className="bg-gradient-to-r from-blue-500 to-sky-400 text-white space-y-3 rounded-xl overflow-hidden
                ...
                <div className="p-4 space-y-3">
                  ...
                  <div className="">
                    <Link to="/blogdetails#top">
                      <button
                        onClick={() => changeBlogIndex(blog.id)}
